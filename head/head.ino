...
// secAudio là thời gian audio phát 
// ques là câu người ta nói
// ans là câu người ta trả lời  
// keyword là cái trả về của Trí
// Anh đã đưa nó về chữ thường không viết hoa và bỏ dấu
void analyseCommand(double &secAudio, String &ques, String &ans, String &keyword) {
  if(ques == "xinchao")
  {
    xinchao();      
  }
...
void build()
{
  while (Serial.available() > 0)
  {
    ...
    if (data == '\r') {
      ...
      analyseCommand(secAudio, ques, ans, keyword);
      Serial.println("OK");
      buff[iCh] = '\0';
      iCh = 0;
    }
